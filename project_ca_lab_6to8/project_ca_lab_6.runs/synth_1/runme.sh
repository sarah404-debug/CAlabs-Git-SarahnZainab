...
HD_PWD='C:/Users/Administrator/Desktop/CAlab/project_ca_lab_6/project_ca_lab_6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log memorySystemFPGA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source memorySystemFPGA.tcl
